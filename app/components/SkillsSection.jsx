        ...
        >
          {skills.tabs.map((tab) => (
            <motion.button
              ...
              className={`px-4 sm:px-6 py-2 sm:py-3 rounded-lg font-semibold text-sm sm:text-base transition-all duration-300 ease-out ${
                activeTab === tab
            ...
            {skills.skillsByCategory[activeTab]?.map((skill, index) => (
              ...
              >
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-sm sm:text-base text-sky-400 font-semibold">
                    {skill.level}%
                  </span>
                </div>
