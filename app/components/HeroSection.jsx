          ...
          >
            ...
            >
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="cursor-pointer px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-slate-600 to-blue-600 text-white rounded-lg font-semibold text-base sm:text-lg shadow-lg hover:shadow-blue-500/30 transition-all w-full sm:w-auto"
              >
                Read More
              </motion.button>
            </motion.div>
